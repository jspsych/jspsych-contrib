/*
 * See https://github.com/google/mediapipe/issues/1408
...
declare global {
   ...
   * Subgroup of FACEMESH_CONNECTIONS.
   */
  export const FACEMESH_LEFT_IRIS: LandmarkConnectionArray;
   ...
   * Subgroup of FACEMESH_CONNECTIONS.
   */
  export const FACEMESH_RIGHT_IRIS: LandmarkConnectionArray;
   ...
   */
  export const FACEMESH_CONTOURS: LandmarkConnectionArray;
   ...
   */
  function matrixDataToMatrix(mat: MatrixData): number[][];
   ...
   */
  type ResultsListener = (results: Results) => Promise<void> | void;
   ...
   * with this metadata.
   */
  class FaceMesh implements FaceMeshInterface {
