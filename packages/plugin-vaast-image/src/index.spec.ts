...
import jsPsychVaastImage from ".";

jest.useFakeTimers();

describe("VAAST-image plugin Test Suite", () => {
  ...
  it("should display the image stimulus", async () => {
    ...
    expect(getHTML()).toContain('src="../examples/stimuli/diamond.png" id="jspsych-vaast-stim"');
