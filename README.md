...
[survey-grid](https://github.com/jspsych/jspsych-contrib/blob/main/packages/plugin-survey-grid/docs/jspsych-survey-grid.md) | [Sam Zorowitz](https://github.com/szorowi1) | This plugin displays a set of questions with Likert scale responses on a grid and provides multiple measures of careless/insufficient effort responding.
