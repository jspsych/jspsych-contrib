...
[densitychart-button-response](https://github.com/jspsych/jspsych-contrib/blob/main/packages/plugin-densitychart-button-response/README.md) | [Courtney B. Hilton](https://github.com/courtney-bryce-hilton) | This plugin displays an interactive density chart to the participant.
